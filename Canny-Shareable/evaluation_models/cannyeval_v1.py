...
class CannyEval():
  ...
  def report_card(self, data_json = None, teacher_student_answers_json=("Deprecated", None, None), teacher_student_answers_csv=(None,None), abbreviations={}, max_marks=5, relative_marking=False, integer_marking=False, json_load_version ="v1"):
